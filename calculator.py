...
result_label.grid(row=0,column=0,columnspan=5,pady=(50,25),sticky='w') #left side bata start huna digit
result_label.config(font=('verdana', 30, 'bold'))  #font size

btn7 = Button(root,text='7',bg='#00a65a',fg='white',width=5,height=2,command=lambda :get_digit(7)) # lambda it is often used to pass arguments to the command function.
